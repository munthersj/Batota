...
const BRAND = {
  name: "بطوطة ديليفري",
  tagline: "توصيل فوري وسريع داخل جميع إمارات الدولة",
  phone: "+971563808849",
...
const SERVICES = [
  ...
  {
    title: "توصيل أغراض",
    desc: "نقل أي أغراض أو طلبات بين الأفراد بسرعة وأمان.",
    icon: "🚚",
  },
  {
    title: "توصيل شركات",
  ...
  {
    title: "توصيل هدايا ومفاجآت",
    desc: "نوصل هديتك بسرعة لتصل في الوقت المثالي.",
    icon: "🎁",
  },
];
              ...
              <div>
                <Reveal>
                  <div className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-semibold text-slate-700 shadow-sm">
                    ...
                    توصيل فوري • تغطية جميع الإمارات • خدمة 24/7
                  </div>
                </Reveal>
                ...
                <Reveal delay={140}>
                  <p className="mt-4 max-w-xl text-sm leading-7 text-slate-600">
                    نقدم خدمات توصيل احترافية للأفراد والشركات داخل جميع إمارات
                    الدولة. توصيل أغراض، هدايا، ورود، مستندات، حيوانات أليفة،
                    وتوصيل بين المدن بسرعة وأمان تام. اطلب الآن وسيتم تأكيد
                    السعر ووقت الوصول فوراً.
                  </p>
                </Reveal>
